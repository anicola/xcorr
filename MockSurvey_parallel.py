        ...
        if self.params['noise']:
            ...
            for j, probe in enumerate(self.params['probes']):
                ...
                if self.params['spins'][j] == 2:
                    ...
                    f2 = nmt.NmtFieldFlat(self.params['Lx'], self.params['Ly'], self.maskmat[j, j], emaps, purify_b=False)
                    ...
                    # Define flat sky spin-0 field
                    emaps = [noisemaps[j]]
                    f0 = nmt.NmtFieldFlat(self.params['Lx'], self.params['Ly'], self.maskmat[j, j], emaps, purify_b=False)
